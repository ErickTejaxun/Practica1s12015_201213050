 ...
 * @author Erick
 */
public class MenuCreacionZombie extends javax.swing.JFrame {
    ...
    public Personaje nuevozombie;
    public int mostradorx;
    public int mostradory;
    
    public MenuCreacionZombie() {
        initComponents();
        for(int x=1;x<100;x++){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Menú De Creación de Personajes  Zombie");
        ...
        jScrollPane1.setBounds(20, 320, 800, 270);
        ...
        Comenzar.setBounds(590, 150, 90, 40);
...
//            iba aqu[i que quiero mostrar las plantas creadas en el panel de a la par :v :v :V
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        nuevozombie=new Personaje();
//        nombre,pathactual,ataque,defensa,tipo
        nuevozombie.nombre=nombre;
        nuevozombie.ataque=ataque;
        nuevozombie.defensa=defensa;
        nuevozombie.tipo=tipo;
        nuevozombie.tipo_personaje="Planta";
        nuevozombie.pathimagen=pathactual;
        nuevonodo=new Nodo(nuevozombie);
        PlantasvsZombis.Lista_zombis.insertar(nuevonodo);
        limpiar();
   ...
   public void limpiar(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuCreacionZombie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuCreacionZombie().setVisible(true);
            }
        });
    }
